    ...
    public class ImageGenerator
    {
        ...
        private void DrawScoreStats(FontFamily family)
        {
            ...
            _image.Mutate(x => x
                ...
                .DrawText($"{_score.ScoreValue}", font, Color.White, new Point(48, 284))
                ...
                .DrawText($"{_score.Combo}/{_score.Beatmap.MaxCombo}", font, color, new Point(538, 284))
                .DrawText("Mods", font, color, new Point(817, 245))
                .DrawText($"{_score.Mods}", font, color, new Point(817, 284))
                // Draw hit circles accuracy
                .DrawText("300", font, color, new Point(48, 350))
                .DrawText($"{_score.Count300}", font, Color.White, new Point(48, 382))
                .DrawText("100", font, color, new Point(138, 350))
                .DrawText($"{_score.Count100}", font, Color.White, new Point(138, 382))
                .DrawText("50", font, color, new Point(218, 350))
                .DrawText($"{_score.Count50}", font, Color.White, new Point(218, 382))
                .DrawText("X", font, color, new Point(280, 350))
                .DrawText($"{_score.CountMiss}", font, Color.White, new Point(280, 382))
